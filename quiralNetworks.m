...
R1 = [-k_1-k_3*L_2-k_4*L_2, -k_3*L_1+k_2, 2*k_5, k_6;
     -k_3*L_2+k_1, -k_2-k_3*L_1-k_4*L_1, 0, 0;
...
RK = [polyD1(2),polyD1(4),0,0;
     polyD1(1),polyD1(3),polyD1(5),0;
     0,polyD1(2),polyD1(4),0;
     0,polyD1(1),polyD1(3),polyD1(5)];
D2 = det(RK,'Algorithm','minor-expansion')